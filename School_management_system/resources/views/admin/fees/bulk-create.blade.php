        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">Bulk Create Fee Records</h1>
                ...
                <div class="bg-blue-50 p-4 rounded-lg mb-6">
                    <p class="text-blue-800">
                        <strong>Note:</strong> This will create fee records for all active students in the selected class.
                    </p>
                </div>
                ...
                <form action="{{ route('admin.fees.bulk-store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="amount" class="block text-sm font-medium text-gray-700">Amount per Student ($)</label>
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        ...
                        <button type="submit" 
                                ...
                                onclick="return confirm('This will create fee records for all students in the selected class. Continue?')">
                            Create Bulk Fee Records
                        </button>
                    </div>
                </form>
            </div>
