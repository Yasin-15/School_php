                ...
                <form action="{{ route('admin.students.update', $student) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" id="address" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $student->user->address) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="transport_required" value="1" {{ old('transport_required', $student->transport_required) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="medical_conditions" id="medical_conditions" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('medical_conditions', $student->medical_conditions) }}</textarea>
                            </div>
                        </div>
                    </div>
